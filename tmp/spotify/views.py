...
# push client info sneakily to development without exposing it 
env = Env()
env.read_env()
...
class AuthURL(APIView):
    ...
    def spotify_callback(request, format=None):
        ...
        # for user page, we would do 'frontend:user'
...
class UserPlaylists(APIView):
    def get(self, request, format=None, sortby=''):
        ...
        # get current user by looking through all User objects for curr code
