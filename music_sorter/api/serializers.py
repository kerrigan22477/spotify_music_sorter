...
class RoomSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'code', 'host', 'guest_can_pause', 'votes_to_skip', 'created_at', 'sorting_criteria')
...
class CreateRoomSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('guest_can_pause', 'votes_to_skip', 'sorting_criteria')
...
class UpdateRoomSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Room
        fields = ('guest_can_pause', 'votes_to_skip', 'code', 'sorting_criteria')